...
func (s *ServiceImpl) GetById(id string, field string, modelType string) (json.RawMessage, error) {
...
func (s *ServiceImpl) GetByParameters(searchParam string, field string, modelType string) (json.RawMessage, error) {
